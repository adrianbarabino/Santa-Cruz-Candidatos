...
/* None */
input#f-pj:checked ~ .graph-container > li:nth-child(1) .bar-inner { height: 0; bottom: -2.5em; }
input#f-pj:checked ~ .graph-container > li:nth-child(2) .bar-inner { height: 0; bottom: -2.5em; }
input#f-pj:checked ~ .graph-container > li:nth-child(3) .bar-inner { height: 0; bottom: -2.5em; }
input#f-pj:checked ~ .graph-container > li:nth-child(4) .bar-inner { height: 0; bottom: -2.5em; }
input#f-pj:checked ~ .graph-container > li:nth-child(5) .bar-inner { height: 0; bottom: -2.5em; }
/* Product 1 */
input#f-partidos:checked ~ .graph-container > li:nth-child(1) .bar-inner { height: <?php echo $datos->fpv; ?>%; bottom: 0; }
input#f-partidos:checked ~ .graph-container > li:nth-child(2) .bar-inner { height: <?php echo $datos->pj; ?>%; bottom: 0; }
input#f-partidos:checked ~ .graph-container > li:nth-child(3) .bar-inner { height: <?php echo $datos->union; ?>%; bottom: 0; }
input#f-partidos:checked ~ .graph-container > li:nth-child(4) .bar-inner { height: <?php echo $datos->po; ?>%; bottom: 0; }
input#f-partidos:checked ~ .graph-container > li:nth-child(5) .bar-inner { height: <?php echo $datos->fut; ?>%; bottom: 0; }
/* Product 2 */
input#f-union:checked ~ .graph-container > li:nth-child(1) .bar-inner { height: 0; bottom: -2.5em; }
input#f-union:checked ~ .graph-container > li:nth-child(2) .bar-inner { height: 0; bottom: -2.5em; }
input#f-union:checked ~ .graph-container > li:nth-child(3) .bar-inner { height: 0; bottom: -2.5em; }
input#f-union:checked ~ .graph-container > li:nth-child(4) .bar-inner { height: 0; bottom: -2.5em; }
input#f-union:checked ~ .graph-container > li:nth-child(5) .bar-inner { height: 0; bottom: -2.5em; }
/* Product 3 */
...
@media screen and (max-width: 900px) {
	...
	.grafico { padding: 20px 20px 40px; }
}
